...
export const FONT_SIZE_MEDIUM = "18px";
export const FONT_SIZE_LARGE = "24px";
export const SPACING_EXTRA_SMALL = "4px";
export const SPACING_SMALL = "8px";
export const SPACING_NORMAL = "16px";
export const SPACING_MEDIUM = "24px";
export const SPACING_LARGE = "32px";
export const SPACING_EXTRA_LARGE = "40px";